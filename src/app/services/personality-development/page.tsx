        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Self-Transformation</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Become the best version of yourself. Our personality development programs focus on building confidence, leadership qualities, and effective communication for all ages.
              </p>
          ...
          <section className="bg-orange-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Core Focus Areas</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    A strong personality is built on a foundation of self-awareness and social intelligence. Our holistic approach ensures that students develop the soft skills necessary to excel in any environment.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    From body language to emotional resilience, we cover the essential traits that distinguish leaders and effective communicators.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Confidence", desc: "Build unshakeable self-belief." },
                    { title: "Leadership", desc: "Learn to inspire and guide others." },
                    { title: "Soft Skills", desc: "Master the art of social interaction." },
                    { title: "Etiquette", desc: "Learn professional and social manners." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <Award />, label: "Focus", value: "Holistic Growth" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-12">Program Modules</h2>
