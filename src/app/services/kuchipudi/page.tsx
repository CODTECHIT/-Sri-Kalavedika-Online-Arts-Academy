        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Experience the vibrant and rhythmic beauty of Kuchipudi. Known for its quick footwork, dramatic characterization, and expressive storytelling.
              </p>
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">The Art of Dramatic Storytelling</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Originating from Andhra Pradesh, Kuchipudi is a dance-drama tradition characterized by fast rhythms, fluid movements, and an intricate blend of acting and dancing. 
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    It distinguishes itself through unique elements like the Tarangam, where the dancer balances on the brass edges of a plate while executing complex rhythmic patterns.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Fluidity", desc: "Develop rounded, graceful body movements." },
                    { title: "Vocal Delivery", desc: "Incorporate lip-syncing and dialogues (Vachika Abhinaya)." },
                    { title: "Tarangam Mastery", desc: "Learn the iconic plate-dancing technique." },
                    { title: "Rhythmic Speed", desc: "Master fast-paced, intricate footwork patterns." },
                  ].map((stat, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Basic Posture & Warmups",
                "Adugulu (Basic Steps)",
                "Jathis and rhythmic patterns",
                "Hastas (Hand Gestures)",
                "Slokams & Invocation items",
                "Shabdam (Expressive pieces)",
                "Keerthana & Padam",
