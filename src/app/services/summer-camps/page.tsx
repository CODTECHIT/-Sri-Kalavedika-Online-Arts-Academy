...
import { Sparkles, Calendar, CheckCircle2, Users, Heart, Clock } from "lucide-react";
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Exploration & Fun</span>
              </div>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-float">
                <img 
                  src="https://images.unsplash.com/photo-1472289065668-ce650ac443d2?auto=format&fit=crop&q=80&w=800" 
                  alt="Summer Camps and Workshops" 
          ...
          <section className="bg-orange-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Immersive Learning</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Our summer camps and workshops are designed to provide a concentrated burst of learning in a fun, non-academic environment. We focus on hands-on activities, group projects, and creative expression.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    From 5-day intensive music workshops to month-long multi-disciplinary summer camps, we have something to ignite every child&apos;s curiosity.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Skill Discovery", desc: "Try something new without a long-term commitment." },
                    { title: "Creative Freedom", desc: "Focus on exploration and fun." },
                    { title: "Social Connection", desc: "Meet peers with similar interests." },
                    { title: "Intensive Growth", desc: "Achieve significant progress in a short time." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              { icon: <Users />, label: "Groups", value: "Age-Appropriate Batches" },
              { icon: <Clock />, label: "Duration", value: "5 Days to 4 Weeks" },
              { icon: <Calendar />, label: "Timing", value: "Vacations & Weekends" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-12">Popular Workshop Topics</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Indian Classical Music Intensive",
                "Speed Cubing Mastery",
                "Creative Writing & Storytelling",
                "Theatre & Drama Workshop",
                "Vedic Maths Crash Course",
                "Art & Craft Heritage",
                "Chess Strategy Camp",
