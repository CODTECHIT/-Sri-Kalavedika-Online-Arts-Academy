          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-6 leading-tight">
                Creative Art & <br />
                <span className="text-secondary">Crafts</span>
              </h1>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Think outside the box! Our creative arts and crafts classes encourage experimentation with mixed media, DIY projects, and imaginative expressions.
              </p>
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Unleashing Imagination</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Creative art goes beyond traditional drawing and painting. It encompasses crafts, mixed media, origami, clay modeling, and recycled art. It's about looking at everyday objects and seeing their artistic potential.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    These classes are especially beneficial for young children as they develop spatial awareness, problem-solving skills, and fine motor coordination while having an immense amount of fun.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Spatial Awareness", desc: "Understanding 3D space through crafts and models." },
                    { title: "Problem Solving", desc: "Figuring out how materials fit together." },
                    { title: "Eco-Friendly", desc: "Learning to upcycle and recycle materials into art." },
                    { title: "Fine Motor Skills", desc: "Cutting, folding, and gluing improve dexterity." },
                  ].map((stat, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                "Best out of Waste (Upcycling)",
                "Greeting Card Making",
                "Finger Painting and Sponge Art",
                "DIY Room Decor projects",
                "Basic Thread and Fabric Art",
