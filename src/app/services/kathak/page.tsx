        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Discover the poetry of Kathak. From mesmerizing pirouettes (chakkars) to lightning-fast footwork and subtle expressions, experience the storytelling dance of North India.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white animate-float bg-white">
                <img 
                  src="/Kathak classes.png"
                  alt="Kathak Classical Dance" 
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">The Dance of Storytellers</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    The word Kathak derives from "Katha", meaning story. The Kathakas were original storytellers who used music, dance, and facial expressions to recite epics. Today, Kathak is a mesmerizing synthesis of Hindu and Muslim cultures.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Our curriculum focuses on the Lucknow and Jaipur Gharanas, teaching you the elegance, grace, and technical prowess required for flawless footwork and spins.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Tatkar (Footwork)", desc: "Develop complex rhythms using ankle bells (ghungroos)." },
                    { title: "Chakkars (Spins)", desc: "Master the iconic rapid, continuous pirouettes." },
                    { title: "Graceful Movement", desc: "Focus on fluid arm movements and subtle wrist actions." },
                    { title: "Bhav (Expression)", desc: "Storytelling through delicate facial expressions." },
                  ].map((stat, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Tatkar (Basic Footwork)",
                "Hand Gestures (Mudras)",
                "Teentaal & Other Taals",
                "Tukdas & Todas",
                "Chakkars (Spins and Pirouettes)",
                "Thaat (Stance and Grace)",
                "Kavitt (Poetry in Dance)",
                "Gat Nikas (Stylized Walk)",
                "Tarana & Thumri Abhinaya"
              ].map((item, i) => (
