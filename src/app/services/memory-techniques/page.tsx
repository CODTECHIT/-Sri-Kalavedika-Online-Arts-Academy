...
import { Brain, Award, CheckCircle2, Users, Clock, Sparkles } from "lucide-react";
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Mind Mastery</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Unlock your brain&apos;s full potential. Learn scientifically proven methods to memorize information faster, retain it longer, and recall it with ease.
              </p>
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Unleash Your Memory</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    A good memory is not a gift—it&apos;s a skill that can be trained. Our program teaches you the same techniques used by memory champions to store vast amounts of information effortlessly.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Whether you are a student preparing for exams or a professional looking to remember names and facts better, our structured training provides the tools you need.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Rapid Retention", desc: "Learn to memorize facts in minutes." },
                    { title: "Long-term Recall", desc: "Keep information in your brain for years." },
                    { title: "Exam Confidence", desc: "Recall answers quickly under pressure." },
                    { title: "Brain Health", desc: "Keep your mind sharp and active." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              { icon: <Users />, label: "Target Age", value: "10 Years & Above" },
              { icon: <Clock />, label: "Duration", value: "2-3 Months" },
              { icon: <Award />, label: "Focus", value: "Information Management" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-12">Techniques You&apos;ll Master</h2>
