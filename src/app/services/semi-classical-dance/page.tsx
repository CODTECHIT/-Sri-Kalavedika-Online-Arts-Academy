...
export default function SemiClassicalPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Fusion Dance</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                The perfect blend of tradition and modernity. Semi-classical dance takes the grace of classical Indian forms and fuses it with the freedom and expressive style of contemporary music.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-float">
                <img 
                  src="https://images.unsplash.com/photo-1516280440502-d2fdaa0bf5e2?auto=format&fit=crop&q=80&w=800"
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Tradition Meets Contemporary</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Semi-classical dance breaks the strict boundaries of traditional classical styles like Bharatanatyam or Kathak, maintaining their aesthetic and technique but applying them to modern, lighter music forms like Ghazals, Sufi, or melodic film songs.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    This style is incredibly popular as it offers the elegance, posture, and facial expressions of classical dance without the requirement of rigorous, multi-year traditional training.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Grace & Poise", desc: "Learn the elegant postures of classical dance." },
                    { title: "Accessible", desc: "Easier to learn compared to pure classical forms." },
                    { title: "Expressive", desc: "Focuses heavily on Abhinaya (facial expressions)." },
                    { title: "Versatile", desc: "Perform to a wide variety of Indian music." },
                  ].map((stat, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Classical Postures & Stances",
                "Basic Mudras (Hand Gestures)",
                "Footwork matching modern beats",
                "Facial Expression Exercises",
                "Choreography to Sufi & Ghazals",
                "Choreography to Melodic Film Songs",
                "Fluid transitions and spins",
                "Understanding Rhythm & Laya",
                "Stage Presentation"
              ].map((item, i) => (
