...
import { Users, MessageCircle, CheckCircle2, BookOpen, Clock, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-white overflow-hidden relative">
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Communication</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Transform into a confident communicator. Master the art of storytelling, engage audiences, and express your ideas with clarity and charisma.
              </p>
          ...
          {/* Why Public Speaking Section */}
          <section className="bg-purple-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                <Sparkles className="text-primary" size={32} />
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Why Storytelling Matters</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    The ability to communicate effectively is one of the most valuable skills in today&apos;s world. Our storytelling and public speaking program empowers you to express ideas compellingly and connect with any audience.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    From children to professionals, everyone benefits from learning to craft stories, deliver speeches, and engage listeners with confidence.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Confidence Building", desc: "Overcome stage fright and speak boldly." },
                    { title: "Story Crafting", desc: "Create compelling narratives that resonate." },
                    { title: "Audience Engagement", desc: "Connect with listeners and hold attention." },
                    { title: "Career Growth", desc: "Excel in interviews, presentations, and leadership." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <BookOpen />, label: "Format", value: "Interactive Workshops" },
            ].map((detail, i) => (
