...
import { Music, Users, BookOpen, Clock, CheckCircle2 } from "lucide-react";

export default function MridangamPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Percussion Arts</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Master the king of percussion. Learn the intricate rhythmic patterns and powerful strokes of the Mridangam, the primary rhythmic accompaniment in Carnatic music.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-float">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/b/bc/Mridangam.jpg"
                  alt="Mridangam Percussion Instrument" 
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">The Heartbeat of Carnatic Music</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    The Mridangam is a double-sided drum whose body is usually made using a hollowed piece of jackfruit wood. It is an ancient instrument that forms the rhythmic backbone of South Indian classical music.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Learning the Mridangam significantly improves mathematical and analytical thinking, as Carnatic rhythms (Taal) are highly structured and involve complex permutations and combinations of beats.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Rhythmic Intelligence", desc: "Develop a profound understanding of complex meters." },
                    { title: "Finger Dexterity", desc: "Build strength, speed, and precision in your hands." },
                    { title: "Konnakol", desc: "Learn the vocal percussion language of the syllables." },
                    { title: "Accompaniment Skills", desc: "Learn how to play alongside a vocalist or instrumentalist." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <Clock />, label: "Duration", value: "Multi-Year Curriculum" },
              { icon: <BookOpen />, label: "Format", value: "Individual & Small Group" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                "Basic Strokes (Tha, Dhi, Thom, Nam)",
                "Konnakol (Vocalizing the rhythms)",
                "Basic Lessons (Sarali Varisais in rhythm)",
                "Understanding the Sapta Taalas",
                "Mohras and Korvais",
                "Playing in different speeds (Kalas)",
                "Accompaniment for Varnams & Kritis",
                "Tani Avartanam (Solo performance)"
              ].map((item, i) => (
