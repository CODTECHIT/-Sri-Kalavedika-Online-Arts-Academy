        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Classical Dance</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Step into the divine world of Bharatanatyam. Learn the ancient temple dance form characterized by complex footwork, expressive mudras, and profound storytelling.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-float">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/e/eb/Murugashankari_Leo.jpg"
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Grace, Posture & Precision</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Bharatanatyam is one of the oldest and most popular classical dance forms of India. It combines Nritta (pure dance), Nritya (expressive dance), and Natya (dramatic storytelling) to convey spiritual ideas.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Practicing Bharatanatyam not only preserves a beautiful cultural heritage but also instills intense discipline, physical fitness, and mental focus. The rigorous adavus (basic steps) and precise geometry of the movements require dedication.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Physical Fitness", desc: "Builds stamina, flexibility, and core strength." },
                    { title: "Expression (Abhinaya)", desc: "Learn to convey emotions using facial expressions." },
                    { title: "Mudras", desc: "Master the intricate hand gestures that tell stories." },
                    { title: "Cultural Connection", desc: "Deepen your roots in Indian mythology and history." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <BookOpen />, label: "Format", value: "Group & Solo Classes" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Namaskaram & Basic Posture (Aramandi)",
                "Tatta Adavus (Basic Footwork)",
                "Natta Adavus & Other variations",
                "Asamyuta & Samyuta Hastas (Mudras)",
                "Alarippu (Invocation piece)",
                "Jatiswaram (Pure dance sequence)",
                "Shabdam (Introduction to Abhinaya)",
