...
import { Mic2, Users, BookOpen, Clock, CheckCircle2 } from "lucide-react";
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Performance Opportunities</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-6 leading-tight">
                Art Recitals & <br />
                <span className="text-secondary">Concerts</span>
              </h1>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Step onto the stage! We regularly organize recitals and mini-concerts to give our students the platform to showcase their hard work and build stage presence.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-float">
                <img 
                  ...
                  alt="Live Concert and Art Recital" 
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Overcoming Stage Fright</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Learning an art form in a classroom is only half the journey. The true test—and joy—of art lies in sharing it with an audience. Our frequent recitals provide a safe, encouraging environment for students to perform.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    These smaller, focused events help students build confidence, learn microphone techniques, and understand the dynamics of performing live, whether as a soloist or in a group.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Confidence", desc: "Drastically reduce stage anxiety through regular exposure." },
                    { title: "Stage Presence", desc: "Learn how to own the stage and engage the audience." },
                    { title: "Technical Setup", desc: "Understand microphones, lighting, and soundchecks." },
                    { title: "Feedback", desc: "Receive constructive feedback from Gurus and peers." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              { icon: <Users />, label: "Target Audience", value: "Enrolled Students" },
              { icon: <Clock />, label: "Frequency", value: "Quarterly Events" },
              { icon: <BookOpen />, label: "Format", value: "Live & Virtual Recitals" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-12">Recital Benefits</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Performing under pressure",
                "Working with live accompanists",
                "Microphone & acoustic techniques",
                "Costume and makeup preparation",
                "Audience interaction & bowing",
