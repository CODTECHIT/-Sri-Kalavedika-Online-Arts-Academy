...
import { Music, Award, CheckCircle2, Users, Clock, BookOpen } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Wind Instruments</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Discover the divine sound of the flute. Master the art of breath control, finger techniques, and soulful melodies under the guidance of our expert maestros.
              </p>
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Course Highlights</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Our flute program is designed to take students from the basics of holding the instrument to performing complex classical compositions. We focus on both technical proficiency and emotional expression.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Whether you are interested in Carnatic flute, Hindustani classical, or light music, our structured curriculum provides a solid foundation for all styles.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Breath Control", desc: "Master the fundamental techniques of breathing." },
                    { title: "Finger Work", desc: "Develop agility and precision in finger movements." },
                    { title: "Classical Roots", desc: "Learn traditional compositions and ragas." },
                    { title: "Performance", desc: "Regular feedback and performance opportunities." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <Clock />, label: "Duration", value: "6-12 Months per Level" },
              { icon: <BookOpen />, label: "Classes", value: "Weekly Interactive Sessions" },
            ].map((detail, i) => (
