        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Urban Dance</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-6 leading-tight">
                Hip-Hop & <br />
                <span className="text-secondary">Urban Styles</span>
              </h1>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Express yourself through street dance. From foundational hip-hop bounces to specialized styles like Locking, Popping, Waacking, and Voguing.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white animate-float">
                <img 
                  src="https://images.unsplash.com/photo-1535597401611-a831e7c52d8c?auto=format&fit=crop&q=80&w=800" 
                  alt="Hip Hop and Urban Dance" 
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Rhythm, Groove & Attitude</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Hip-Hop is more than just a dance; it's a culture of self-expression. Our classes break down complex grooves, isolations, and footwork, ensuring you build a strong foundation.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Beyond basic hip-hop, we introduce students to specialized street styles like Locking (funky, sharp stops), Popping (muscle tensing to the beat), Waacking (fast arm movements), and Voguing.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Musicality", desc: "Learn to hit every beat and understand music structure." },
                    { title: "Body Isolations", desc: "Control individual body parts independently." },
                    { title: "Freestyle", desc: "Develop the confidence to improvise and battle." },
                    { title: "Stamina & Fitness", desc: "A rigorous cardiovascular workout." },
                  ].map((stat, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "Hip-Hop Foundations (Groove & Bounce)",
                "Isolations & Body Control",
                "Introduction to Popping & Dimestopping",
                "Locking fundamentals",
                "Waacking arm pathways",
                "Voguing lines and poses",
                "Choreography Pickup Skills",
                "Freestyle techniques",
                "Cypher (Circle) Etiquette"
              ].map((item, i) => (
