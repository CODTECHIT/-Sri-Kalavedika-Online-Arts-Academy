...
import { Mic2, Sparkles, BookOpen, Clock, Users, CheckCircle2 } from "lucide-react";

export default function BeatBoxingPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Contemporary Arts</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Turn your voice into a percussion instrument. Learn the art of vocal percussion, from basic kicks and snares to advanced sound effects and looping techniques.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-xl">
              <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white animate-float bg-white">
                <img 
                  src="/beat boxing.jpeg" 
                  alt="Beatboxing and Vocal Percussion" 
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">The Art of Vocal Percussion</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Beatboxing is the incredible art of producing drum beats, rhythm, and musical sounds using one's mouth, lips, tongue, and voice. It's a highly engaging and modern musical form that requires precision, breath control, and creativity.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Our Beatboxing course is designed to take you from the very basics (boots and cats) to performing complex routines and integrating vocal percussion with other musical instruments.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Breath Control", desc: "Build stamina for continuous rhythm production." },
                    { title: "Rhythm & Timing", desc: "Develop a strong internal metronome." },
                    { title: "Creative Expression", desc: "Create unique soundscapes and drops." },
                    { title: "Confidence", desc: "Perform fearlessly in front of audiences." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <BookOpen />, label: "Format", value: "Interactive Live Classes" },
            ].map((detail, i) => (
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-primary mb-12">Curriculum Breakdown</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                "The Basic 3: Kick, Hi-Hat, Snare",
                "Breathing Techniques & Stamina",
                "Inward vs Outward Sounds",
                "Click Rolls and Bass Sounds",
                "Throat Bass & Lip Roll",
                "Creating Patterns & Routines",
                "Microphone Techniques",
                "Introduction to Loop Stations",
                "Jamming and Battling Basics"
              ].map((item, i) => (
