...
import { Users, Mic2, CheckCircle2, Star, Clock, MessageCircle } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                ...
                <span className="text-secondary font-bold uppercase tracking-widest text-sm">Performance Arts</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary mb-6 leading-tight">
                Theatre & <br />
                <span className="text-secondary">Acting</span>
              </h1>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Unleash your inner actor with our comprehensive theatre program. Build confidence, master expressions, and shine on stage.
              </p>
          ...
          <section className="bg-orange-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">Why Theatre Training?</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Theatre training is one of the most powerful tools for personality development. It enhances public speaking, emotional intelligence, body language, and creative thinking.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Our program covers drama, speech, mime, improvisation, and stagecraft — giving you a complete toolkit for confident self-expression.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Voice Modulation", desc: "Master pitch, tone, and volume control." },
                    { title: "Facial Expressions", desc: "Communicate emotions effectively." },
                    { title: "Body Language", desc: "Use gestures and movement to tell stories." },
                    { title: "Script Analysis", desc: "Understand and embody characters deeply." },
                  ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            {[
              ...
              { icon: <MessageCircle />, label: "Format", value: "Interactive Sessions" },
            ].map((detail, i) => (
