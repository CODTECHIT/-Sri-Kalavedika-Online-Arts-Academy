          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Bring your imagination to life with colors! Learn various painting mediums including watercolors, acrylics, and oil paints in our comprehensive painting courses.
              </p>
          ...
          <section className="bg-blue-50 rounded-[4rem] p-12 md:p-20 mb-32 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">The Magic of Color Theory</h2>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Painting is more than just applying color to a canvas; it's about understanding how colors interact, how to create texture, and how to evoke emotion through brushstrokes.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Our painting courses take you through the intricacies of color theory and various mediums. Whether you prefer the translucent beauty of watercolors or the bold textures of acrylics, we have a specialized path for you.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { title: "Color Theory", desc: "Master the color wheel, mixing, and harmony." },
                    { title: "Multiple Mediums", desc: "Explore Watercolors, Acrylics, Poster, and Oils." },
                    { title: "Stress Relief", desc: "Painting is a known therapeutic activity." },
                    { title: "Self Expression", desc: "Communicate complex feelings through art." },
                  ].map((stat, i) => (
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                "Watercolor washes and glazing",
                "Acrylic blending and textures",
                "Still Life painting",
                "Landscape and nature painting",
                "Portrait painting basics",
                "Abstract and contemporary styles",
                "Preserving and framing artworks"
              ].map((item, i) => (
