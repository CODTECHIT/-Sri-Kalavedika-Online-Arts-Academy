      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              Nurturing talent, preserving tradition, and inspiring artistic
              excellence across the globe through structured online academy
              tracks.
            </p>
            {/* Social Icons */}
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, rgba(196,136,42,0.4), transparent)",
          }}
        />
        ...
        >
          <p>
            © {new Date().getFullYear()} Sri Kalavedika Online Arts Academy. All
            Rights Reserved.
          </p>
          <div className="flex items-center gap-1.5">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[#f5c842] transition-colors font-semibold"
            >
